...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* ========================================================= */}
      {isMobileMenuOpen && (
        <div className="absolute top-14 left-0 w-full bg-richblack-800 border-b border-richblack-700 md:hidden z-50 py-4">
           <div className="flex flex-col items-center gap-y-4 text-richblack-25 text-lg">
              
              {/* Links */}
              {NavbarLinks.map((link, index) => (
                 <div key={index}>
                    {link.title === "Catalog" ? (
                       // Simple Catalog Link for Mobile (Future: make this a dropdown)
              ...
              {token === null && (
                 <div className="flex flex-col gap-y-4 mt-2">
                    <Link to="/login" onClick={handleLinkClick}>
                       <button className="rounded-[8px] border border-richblack-700 bg-richblack-700 px-[12px] py-[8px] text-richblack-100 w-full">
                          Log in
                       </button>
                    </Link>
